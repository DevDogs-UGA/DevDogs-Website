  ...
  return (
    <div>
      <div className="section section-about">
        <div id="abouttitle">
          <h1>
            More <b className="dark_red-bold">About Us</b>
          </h1>
        </div>
        ...
        <div className="grid">
          <div>
            <h1 id="whoweare">
              {" "}
              <b className="dark_red-bold">Who </b>We Are
            </h1>
            <p>
        ...
        <div className="grid">
          <div>
            <h1 id="whoweare">
              Our <b className="dark_red-bold">Mission</b>
            </h1>
            <p>
        ...
        <div className="impact-section">
          <h1 id="impact">
            Our <b className="dark_red-bold">Impact</b>
          </h1>
          <br />
          ...
          <div className="flex flex-nowrap items-center justify-center ">
            <Link
              className="bg-NavBarColor rounded-full text-white mr-4 py-3 px-6 transition ease-in-out duration-200 hover:bg-black"
              href="/about/projects"
            >
            ...
            <br />
            <Link
              className="bg-UGA rounded-full text-white ml-4 py-3 px-6 transition ease-in-out duration-200 hover:bg-black"
              href="/about/people"
            >
