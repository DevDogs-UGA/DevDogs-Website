      ...
      <div className="section">
        ...
        <div className="page-main-side-padding py-[2rem]">
          ...
          <div className="flex flex-nowrap items-center justify-center gap-[2rem] py-4">
            <Link
              href="/about/projects"
              className="rounded-full px-4 py-2 text-lg font-medium bg-DevDogBlue text-white hover:bg-black hover:text-white  transition delay-150 ease-in-out sm:px-6 md:text-xl"
            >
            ...
            <Link
              target="_blank"
              href="/about/people"
              className=" bg-[#BA0C2F] hover:bg-black hover:text-white  rounded-full px-4 py-2 text-lg font-medium text-white transition delay-150 ease-in-out sm:px-6 md:text-xl"
            >
